...
public enum BlogErrorInformation implements ErrorInformation {
    ...
    COLOG_MEMBER_UPDATE_FORBIDDEN(HttpStatus.FORBIDDEN, "팀 멤버 정보 수정 권한이 없습니다."),
    COLOG_SELF_PERMISSION_UPDATE_FORBIDDEN(HttpStatus.BAD_REQUEST, "자기 자신의 권한은 변경할 수 없습니다."),
    COLOG_MEMBER_UPDATE_REQUEST_EMPTY(HttpStatus.BAD_REQUEST, "수정할 팀 멤버 정보가 없습니다."),
    ...
    DUPLICATED_PUBLISH(HttpStatus.BAD_REQUEST, "발행된 글을 다시 발행할 수 없습니다.")
    ;
