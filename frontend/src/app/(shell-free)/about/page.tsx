		...
		<main className={styles.page}>
			...
			<section className={styles.manifestoMeaningSection} aria-label="Rilog의 의미">
				...
				<div className={styles.manifestoMeaningBody}>
					...
					<p className={styles.manifestoMeaningSubheading}>
						<strong>write deeper.</strong>
					</p>
					<p>
						우리는 읽고 쓰는 데 들인 시간의 가치를 믿습니다. 한 편의 글을 천천히 읽으며 타인의 선택을 이해하고, 익숙했던
						생각을 새롭게 바라보는 경험을 소중히 여깁니다. 깊이 탐구한 기술 이야기부터 일과 삶을 돌아보는 솔직한
						기록까지, 서로의 이야기에 귀 기울이며 생각을 나누는 문화를 만들어갑니다.
					</p>
					<p>
					...
					<p>
						<code>Colog</code>는 <code>Cooperation</code>과 <code>Blog</code>를 결합한 합성어로 팀 단위의 블로그를
						의미합니다. 프로젝트를 이끌어온 깊은 고민부터 함께 웃었던 소소한 순간까지, 각자의 시선으로 함께한 시간을
