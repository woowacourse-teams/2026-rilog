...
export default function CologChapterRow({ chapter, onDelete }: CologChapterRowProps) {
	return (
		<tr className="h-18.5 border-b border-border-default">
			<td className="py-3 pl-6 text-body-1 font-semibold text-text-primary">{chapter.name}</td>
