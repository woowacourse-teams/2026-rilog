...
export default function CologDangerZoneSection({ onDeleteTeam, onTabChangeRequest }: CologDangerZoneSectionProps) {
			...
			<section className="px-6 sm:px-8 lg:px-0">
				<div className="mt-2.5 rounded-lg bg-danger-soft px-6 py-10 sm:px-12 md:min-h-75 md:px-16 md:py-18">
					...
					<p className="mt-3 text-body-1 text-text-primary">
						팀과 팀의 모든 설정이 영구적으로 삭제됩니다. 게시글은 작성자 개인 글로 전환되며, 이 작업은 취소할 수
						없습니다.
					</p>
					<Button
						type="button"
