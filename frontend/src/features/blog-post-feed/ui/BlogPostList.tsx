	...
	return (
		<ul className="flex flex-col gap-7">
			{posts.map((post, index) => {
				const metadataName = blogType === 'COLOG' || post.blog.type === 'RILOG' ? post.author.nickname : post.blog.name;
				...
				return (
					<li key={post.id}>
						...
						>
							<div className="relative aspect-3/2 h-28 w-36 shrink-0 overflow-hidden rounded-lg bg-thumbnail-background sm:h-32 sm:w-auto">
								<PostFeedImage
